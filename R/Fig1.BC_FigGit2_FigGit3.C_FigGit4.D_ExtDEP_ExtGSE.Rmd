---
title: "Figure 1 BC, Github Figure 2, Github Figure 3 C, Github Figure S4 D, Extended Data DEP, Extended Data GSE"
author:
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(
    "..", "results", "Fig1.BC_FigGit2_FigGit3.C_FigGit4.D_ExtDEP_ExtGSE.html"
  ))})
---
...
*The purpose of this file is to reproduce results from the associated paper, specifically sections B and C of Figure 1, Github Figure 2, section C of Github Figure S3, and the DEP and GSE sections of Extended Data.*
...
packages <- c(
  ...
  "scales", "limma", "DT", "GSEABase", "GSVA", "biomaRt", "circlize", "VennDiagram", "RColorBrewer"
)
...
Only fraction 1 is shown here as a representative example, but the others can be trivially produced by removing chunk options that are suppressing output when re-running this R Markdown.
...
This figure is a Venn diagram comparing DEPs in the imputed, unimputed, and complete cases pipelines.
All limma parameters are set the same as the prior DEP analysis.
The DEPs compared for each pipeline are those with an adjusted F p-value of less than 0.05.
...
for (i in seq_along(data_list)) {
  ...
  # Add proteins with adjusted F p-values of less than 0.05 to the Venn diagram list.
  # ---------------------------------------------------------------------------------
  venn_list[[i]] <- results[results$F.p.value.adj < 0.05, ]$X
  # ---------------------------------------------------------------------------------
}
# ------------------------------------------------------------------
