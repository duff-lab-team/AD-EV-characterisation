...
*The purpose of this file is to reproduce results from the manuscript rebuttal, specifically Rebuttal Figure 2, Rebuttal Figure 3, and Sections A and B of Rebuttal Figure 4.*
...
# Commonly used paths.
# --------------------
data_dir <- file.path("..", "data", "rebuttal")

cache_dir <- file.path("..", "tmp", "rebuttal")
