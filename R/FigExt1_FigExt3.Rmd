---
title: "Extended Data Figure 1, Extended Data Figure 3"
author:
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_file = file.path("..", "results", "FigExt1_FigExt3.html"
  ))})
---
...
*The purpose of this file is to reproduce results from the manuscript rebuttal, specifically Extended Data Figure 1 and Extended Data Figure 3.*
...
# -----------------------------------------------------
packages <- c(
  "conflicted", "Matrix", "Seurat", "DEP", "SummarizedExperiment", "magrittr", "tibble", "dplyr", "ggplot2", "scales",
  "circlize", "ComplexHeatmap", "GSEABase", "GSVA"
)
...
cache_dir <- file.path("..", "tmp", "proteins")
...
if (file.exists(rds)) {
  ...
  data <- read.csv(file.path(data_dir, "allen-human-cortical-tx", "exon.csv"))
  meta <- read.csv(file.path(data_dir, "allen-human-cortical-tx", "metadata.csv"))
