---
title: "Github Figure 3 AB, Github Figure S4 ABC"
author:
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(
    "..", "results", "FigGit3.AB_FigGit4.ABC.html"
  ))})
---
...
*The purpose of this file is to reproduce results from the associated paper, specifically sections A and B of Github Figure 3 and sections A, B, and C of Github Figure 4.*
